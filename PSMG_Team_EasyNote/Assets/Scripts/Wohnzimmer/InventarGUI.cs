...
public class InventarGUI : MonoBehaviour
{
    ...
    void inventoryWindowMethodW(int windowId)
    {
        ...
        if (button0 = GUI.Toggle(new Rect(10, 70, 160, 50), button0, inventoryNameDictionary[0], "button"))
        {
            button0 = true;
        ...
        if (button1 = GUI.Toggle(new Rect(200, 70, 160, 50), button1, inventoryNameDictionary[1], "button"))
        {
            button1 = true;
        }
        else
        ...
        GUILayout.BeginHorizontal();
        if (button2 = GUI.Toggle(new Rect(10, 140, 160, 50), button2, inventoryNameDictionary[2], "button"))
        {
            button2 = true;
        }
        else
        ...
        if (button3 = GUI.Toggle(new Rect(200, 140, 160, 50), button3, inventoryNameDictionary[3], "button"))
        {
            button3 = true;
        }
        else
    ...
    void getActiveToggleW()
    {
        if (button0 && button1)
        {
            kombi = inventoryNameDictionary[0] + inventoryNameDictionary[1];


        }
        if (button0 && button2)
        {
            kombi = inventoryNameDictionary[0] + inventoryNameDictionary[2];

        }
        if (button0 && button3)
        {
            kombi = inventoryNameDictionary[0] + inventoryNameDictionary[3];

        }
        if (button1 && button2)
        {
            kombi = inventoryNameDictionary[1] + inventoryNameDictionary[2];

        }
        if (button1 && button3)
        {

            kombi = inventoryNameDictionary[1] + inventoryNameDictionary[3];

        }
        if (button2 && button3)
        {

            kombi = inventoryNameDictionary[2] + inventoryNameDictionary[3];
    ...
    void testKombi()
    {
        if (kombi.Equals("SägeSpazierstock") || match.Equals("SpazierstockSäge"))
        {
            //Kombinieren
