...
public class movingCamera : MonoBehaviour
{
    ...
    void Start()
    {
        //Startposition
        setToStartPos();
        schrank = GameObject.FindGameObjectWithTag("wasserhahn");
        korb = GameObject.FindGameObjectWithTag("teppich");
    ...
    void Update()
    {
        ...
        if (Input.GetMouseButtonDown(0))
        {
            ...
            if (Physics.Raycast(ray, out hit, 50))
            {
                ...
                if (hit.transform.gameObject.tag == "wasserhahn")
                {
                    ...
                    cameraPos = "hintereWand";
                }


                if (hit.transform.gameObject.tag == "teppich")
                {
                ...
                if (hit.transform.gameObject.tag == "toilette")
                {
